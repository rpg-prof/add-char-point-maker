...
export const skills: SkillOption[] = [
  ...
  { name: "Marinhagem", cost: 3, attribute: "Sabedoria/Destreza", group: "Geral", description: "Conhecimentos básicos de navegação marítima, manejo de velas, cordas e equipamentos de bordo." },
  { name: "Mergulho", cost: 2, attribute: "Destreza/Constituição", group: "Geral", description: "Habilidade de mergulhar em águas profundas, controlar respiração e movimentar-se submerso." },
  { name: "Mineração", cost: 5, attribute: "Sabedoria/Força", group: "Geral", description: "Conhecimento de técnicas de mineração, identificação de minérios e trabalho em túneis e minas." },
  ...
  { name: "Navegador", cost: 3, attribute: "Inteligência/Sabedoria", group: "Geral", description: "Perícia avançada de navegação, incluindo uso de mapas e instrumentos náuticos." },
  { name: "Navegar Bote", cost: 2, attribute: "Força/Inteligência", group: "Geral", description: "Habilidade de conduzir pequenas embarcações como botes, canoas e jangadas." },
  ...
  { name: "Sapataria", cost: 3, attribute: "Destreza/Inteligência", group: "Geral", description: "Habilidade de confeccionar e reparar calçados de todos os tipos." },
  { name: "Tecelagem", cost: 3, attribute: "Inteligência/Destreza", group: "Geral", description: "Conhecimento de técnicas de tecelagem para criar tecidos e tapetes." },
  { name: "Trabalhar Pedra", cost: 4, attribute: "Força/Sabedoria", group: "Geral", description: "Habilidade de cortar, moldar e trabalhar com pedra para construção e escultura." },
  { name: "Treinar Animais", cost: 4, attribute: "Sabedoria/Carisma", group: "Geral", description: "Habilidade de treinar animais para obedecer comandos e realizar tarefas específicas." },
  ...
  { name: "Leis", cost: 3, attribute: "Inteligência", group: "Geral", description: "Conhecimento das leis e regulamentos locais e regionais." },
  ...
  { name: "Mãos Estáveis", cost: 1, attribute: "Destreza", group: "Geral", description: "Mãos firmes e precisas, úteis para trabalhos delicados e manuseio cuidadoso de objetos." },
  ...
  { name: "Intriga na Corte", cost: 4, attribute: "Sabedoria/Inteligência", group: "Geral", description: "Habilidade de navegar intrigas políticas e jogos de poder em cortes e ambientes nobres." },
  { name: "Prestidigitação", cost: 3, attribute: "Destreza", group: "Geral", description: "Habilidade de realizar truques de mão, ilusionismo simples e manipulação rápida de objetos pequenos." },
  // Sacerdotes
  { name: "Astrologia", cost: 3, attribute: "Sabedoria/Inteligência", group: "Sacerdote", additionalGroups: ["Mago"], description: "Pode preparar estudo do futuro (30 dias) baseado em data/local de nascimento. Previsão vaga de eventos genéricos. +1 em Navegação se estrelas visíveis." },
  { name: "Conhecimento Místico", cost: 3, attribute: "Inteligência", group: "Sacerdote", additionalGroups: ["Mago"], description: "Familiaridade com formas e cerimônias mágicas. Pode identificar magias sendo lançadas e reconhecer objetos mágicos (metade da chance)." },
  ...
  { name: "Herbalismo", cost: 3, attribute: "Inteligência/Sabedoria", group: "Sacerdote", additionalGroups: ["Mago"], description: "Identificar plantas e fungos, preparar poções, cataplasmas, pós, ungüentos e venenos naturais. Combinado com Cura, bônus no tratamento." },
  { name: "História Antiga", cost: 3, attribute: "Sabedoria/Inteligência", group: "Sacerdote", additionalGroups: ["Ladrão/Bardo", "Mago"], description: "Conhecimento de lendas, tradições e história de tempos antigos. Familiaridade com eventos, vultos históricos, batalhas e mistérios." },
  { name: "História Local", cost: 2, attribute: "Inteligência/Carisma", group: "Sacerdote", additionalGroups: ["Ladrão/Bardo"], description: "Depósito de fatos sobre a história de uma região. Conhece heróis, vilões, tesouros e eventos locais. Pode contar histórias (+2 Carisma)." },
  { name: "Idiomas Antigos", cost: 4, attribute: "Inteligência", group: "Sacerdote", additionalGroups: ["Mago"], description: "Dominou língua obscura encontrada em textos de sábios e magos. Pode ler segredos escritos por místicos antigos." },
  { name: "Ler/Escrever", cost: 2, attribute: "Inteligência", group: "Sacerdote", additionalGroups: ["Mago"], description: "Pode ler e escrever numa linguagem moderna que também fale. Não permite ler textos antigos." },
  { name: "Religião", cost: 2, attribute: "Sabedoria", group: "Sacerdote", additionalGroups: ["Mago"], description: "Conhece crenças e cultos da região. Informações comuns são automáticas; específicas requerem teste. Pontos extras ampliam para outras regiões." },
  // Ladrão / Bardo
  ...
  { name: "Criptografia", cost: 3, attribute: "Inteligência/Sabedoria", group: "Ladrão/Bardo", additionalGroups: ["Mago"], description: "Habilidade de criar e decifrar códigos e mensagens cifradas." },
  ...
  { name: "Lapidação", cost: 3, attribute: "Destreza", group: "Ladrão/Bardo", additionalGroups: ["Mago"], description: "Lapidar pedras brutas: 1d10 pedras/dia. Sucesso aumenta valor ao nível apropriado. Resultado 1 = trabalho excepcional, sobe uma categoria." },
  ...
  { name: "Lutar no Escuro", cost: 4, attribute: "Sabedoria/Destreza", group: "Ladrão/Bardo", additionalGroups: ["Guerreiro"], description: "Habilidade de combater eficientemente em condições de escuridão total ou quase total." },
  ...
  { name: "Preparar Armadilhas", cost: 3, attribute: "Destreza/Sabedoria", group: "Ladrão/Bardo", additionalGroups: ["Guerreiro"], description: "Habilidade de construir e armar armadilhas para captura ou defesa." },
  ...
  { name: "Camuflagem", cost: 5, attribute: "Inteligência", group: "Ladrão/Bardo", additionalGroups: ["Guerreiro"], description: "Habilidade de camuflar-se no ambiente, tornando-se difícil de detectar." },
  { name: "Luta Suja", cost: 3, attribute: "Inteligência", group: "Ladrão/Bardo", additionalGroups: ["Guerreiro"], description: "Técnicas de combate desleal como jogar areia nos olhos, golpes baixos e truques sujos." },
  { name: "Manha das Ruas", cost: 3, attribute: "Sabedoria/Carisma", group: "Ladrão/Bardo", description: "Conhecimento da vida nas ruas, contatos no submundo e habilidade de sobreviver em ambientes urbanos perigosos." },
  ...
  // Magos (perícias exclusivas do Mago)
  ...
  { name: "Armadura Mental", cost: 1, attribute: "Inteligência", group: "Mago", description: "Técnica de proteção mental contra intrusões psíquicas e ataques mentais." },
